...
internal fun FocusModeSettingsContent(
    ...
    if (focusModeEnabled) {
        SettingsPremiumSwitchItem(
            title = stringResource(R.string.settings_focus_mode_strict),
            description = stringResource(R.string.settings_focus_mode_strict_desc),
            checked = focusModeStrict,
            isPremium = isPremium,
            onCheckedChange = { checked ->
                if (isPremium) {
                    onStrictModeToggle(checked)
                }
            },
